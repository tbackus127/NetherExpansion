...
public class RathRenderMysticShot extends Render {

	public void renderMysticShot(EntityRathMysticShot par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
	{
	...
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
		this.renderMysticShot((EntityRathMysticShot)par1Entity, par2, par4, par6, par8, par9);
	}
}

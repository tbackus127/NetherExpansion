...
public class EntityRathBlazingShot extends Entity
{
	private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
	...
	public EntityRathBlazingShot(World par1World)
    {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    }

    public EntityRathBlazingShot(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    ...
    public EntityRathBlazingShot(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
    ...
    public EntityRathBlazingShot(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        this.shootingEntity = par2EntityLiving;
    ...
    public void onUpdate()
    {
        ...
        if (this.inGround)
        {
        	int blazeFireX = this.xTile;
        	int blazeFireY = this.yTile;
        	int blazeFireZ = this.zTile;
        	if(this.worldObj.getBlockId(blazeFireX, blazeFireY + 1, blazeFireZ) == 0)
        	{
        		this.worldObj.setBlockAndMetadataWithUpdate(blazeFireX, blazeFireY + 1, blazeFireZ, 51, 0, true);
        	}
        	this.setDead();
        }
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var22 = RathuldrNether.causeBlazingShotDamage(this, this);
                    }
                    else
                    {
                        var22 = RathuldrNether.causeBlazingShotDamage(this, this.shootingEntity);
                    }
            ...
            // Custom particle testing...
            for(int var88 = 0; var88 < 4; ++var88)
            {
            	this.worldObj.spawnParticle("lava", this.posX + this.motionX * (double)var88 / 4.0D, this.posY + this.motionY * (double)var88 / 4.0D, this.posZ + this.motionZ * (double)var88 / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
            }
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(RathuldrNether.itemMysticShot, 1)))
            {
                var2 = false;
            }

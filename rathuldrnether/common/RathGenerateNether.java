...
public class RathGenerateNether extends WorldGenerator 
{
	private int blockGenId;
	private int numberOfBlocks;
	private int iMeta;
	
	public RathGenerateNether(int blockId, int metadata, int numBlocks)
	{
		blockGenId = blockId;
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                {
                                	//System.out.println("Generated " + blockGenId + " at " + var38 + ", " + var41 + ", " + var44 + ".");
                                	par1World.setBlockAndMetadata(var38, var41, var44, this.blockGenId, iMeta);
                                }
                            }
                        }
                    }

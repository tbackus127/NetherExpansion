...
public class RathRenderBlazingShot extends Render {

	public void renderBlazingShot(EntityRathBlazingShot par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
	{
		this.loadTexture("/rathuldr/img/mysticShot.png");
		GL11.glPushMatrix();
	...
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
		this.renderBlazingShot((EntityRathBlazingShot)par1Entity, par2, par4, par6, par8, par9);
	}
}

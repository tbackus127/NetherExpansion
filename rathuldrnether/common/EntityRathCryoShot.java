...
public class EntityRathCryoShot extends Entity
{
	private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
	...
	public EntityRathCryoShot(World par1World)
    {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    }

    public EntityRathCryoShot(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    ...
    public EntityRathCryoShot(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
    ...
    public EntityRathCryoShot(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        this.shootingEntity = par2EntityLiving;
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var22 = RathuldrNether.causeCryoShotDamage(this, this);
                    }
                    else
                    {
                        var22 = RathuldrNether.causeCryoShotDamage(this, this.shootingEntity);
                    }
            ...
            {
            	this.worldObj.spawnParticle("splash", this.posX + this.motionX * (double)var88 / 4.0D, this.posY + this.motionY * (double)var88 / 4.0D, this.posZ + this.motionZ * (double)var88 / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
            }
